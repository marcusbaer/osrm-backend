                                    ...
                                    const bool reverse_target)
{
    ...
    const source_segment_start_coordinate =
        source_node.fwd_segment_position + (reverse_source ? 1 : 0);
    ...
    const target_segment_end_coordinate =
        target_node.fwd_segment_position + (reverse_target ? 1 : 0);
